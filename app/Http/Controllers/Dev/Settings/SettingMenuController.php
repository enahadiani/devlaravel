...
class SettingMenuController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        try {   
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/menu',[
                    'headers' => [
    ...
    public function storeMove(Request $request) {
        ...
        try {
            ...
            $client = new Client();
            $response = $client->request('POST',  config('api.url').'dev/menu-move',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
    ...
    public function show(Request $request) {
        try{
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'dev/menu',
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
    ...
    public function update(Request $request) {
        ...
        try {
            $client = new Client();
            $response = $client->request('PUT',  config('api.url').'dev/menu',[
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
                ],
    ...
    public function delete(Request $request) {
        try{
            $client = new Client();
            $response = $client->request('DELETE',  config('api.url').'dev/menu',
            [
                'headers' => [
                    'Authorization' => 'Bearer '.Session::get('token'),
                    'Accept'     => 'application/json',
