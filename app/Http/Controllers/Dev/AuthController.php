<?php 
    ...
    class AuthController extends Controller {
        ...
        public function cek_auth(Request $request)
        {
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/login',[
                    'form_params' => [
                ...
                if ($response->getStatusCode() == 200) { // 200 OK
                    ...
                    if($data["message"] == "success"){
                        ...
                        $response2 = $client->request('GET',  config('api.url').'dev/profile',[
                            'headers' => [
                        ...
                        return redirect('dev-auth/login')->with('alert','Password atau NIK, Salah !');
                    }
                ...
                return redirect('dev-auth/login')->with('alert',$message);
            }
        ...
        {
            Session::flush();
            return redirect('dev-auth/login')->with('status','logout');
        }
        ...
        public function getMenu(){
            try {
                ...
                $response = $client->request('GET',  config('api.url').'dev/menu/'.$kodemenu,[
                    'headers' => [
        ...
        public function getProfile(){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'dev/profile',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ]
        ...
        public function updatePassword(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/update-password',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updatePhoto(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/update-foto',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function updateBackground(Request $request){
            ...
            try {
                ...
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/update-background',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchForm(Request $request){
            ...
            try {
                $client = new Client();
                $response = $client->request('POST',  config('api.url').'dev/search-form',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
        ...
        public function searchFormList(Request $request){
            try {
                $client = new Client();
                $response = $client->request('GET',  config('api.url').'dev/search-form-list',[
                    'headers' => [
                        'Authorization' => 'Bearer '.Session::get('token'),
                        'Accept'     => 'application/json',
                    ],
