    ...
    <form id="menu-form">
        <div class="row" id="saku-filter">
            <div class="col-12 mb-2">
                <div class="card" >
                    <div class="card-body p-4" style="min-height:69.2px">
        ...
        <div class="row" id="saku-data" style="display:none">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div id="detMenu" class="card-body pt-0" style="overflow-y:scroll;height:calc(100vh - 235px)">
...
<script type="text/javascript">
    ...
    function init(kode_klp){
        $.ajax({
            type: 'GET',
            url: "{{ url('dev-master/setting-menu') }}",
            dataType: 'json',
    ...
    $(document).ready(function(){
        ...
        e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('dev-master/setting-menu-move') }}",
                dataType: 'json',
                data: formData,
                async:false,
                contentType: false,
