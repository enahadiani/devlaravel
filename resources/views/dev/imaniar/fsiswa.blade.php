                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control inp-label-kode_jur" id="kode_jur" name="kode_jur" placeholder="Jurusan" value="" title="">
...
<!-- END MODAL CBBL -->
    ...
    // DATABASE - DATA SISWA
        ...
        // BUTTON HAPUS DATA - PREVIEW DATA
        ...
        // END BUTTON HAPUS DATA - PREVIEW DATA

        // BUTTON EDIT DATA - PREVIEW DATA
        ...
        // END BUTTON EDIT DATA - PREVIEW DATA

        // BUTTON CEKTAK DATA - PREVIEW DATA
        $('.modal-header').on('click','#btn-cetak',function(e){
            e.stopPropagation();
            $('.dropdown-ke1').addClass('hidden');
            $('.dropdown-ke2').removeClass('hidden');
        });
        // END BUTTON CEKTAK DATA - PREVIEW DATA
        ...
        // END PREVIEW DATA - TABEL DATA SISWA 
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.data.status){
                        ...
                        showNotification("top", "center", "success",'Hapus Data','Data Siswa dengan NIS ('+id+') berhasil dihapus ');
                        $('#modal-pesan-id').html('');
    ...
    // FORM TAMBAH DATA SISWA
        ...
        // END BUTTON SEARCH PADA FORM INPUT

        // BUTTON HAPUS JURUSAN
