{{-- Referensi file fVendor folder Esaku --}}
    ...
    <x-list-data judul="Data Siswa" tambah="true" :thead="array('NIS','Nama','Status','Action')" :thwidth="array(15,15,15,15)" :thclass="array('','','','text-center')" />
    <!-- END LIST DATA -->
...
// END BAGIAN CBBL
    ...
    $('#table-data tbody').on('click','td',function(e){
        if($(this).index() != 2){
            ...
            $('#modal-preview-judul').text('Preview Siswa');
