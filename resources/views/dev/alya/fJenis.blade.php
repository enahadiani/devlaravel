{{-- Referensi file fVendor folder Esaku --}}
    ...
    <x-list-data judul="Data Jenis" tambah="true" :thead="array('Kode','Nama','Status','Action')" :thwidth="array(15,15,15,15)" :thclass="array('','','','text-center')" />
    <!-- END LIST DATA -->
