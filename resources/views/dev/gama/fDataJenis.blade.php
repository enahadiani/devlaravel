...
<x-list-data judul="Data Jenis" tambah="true" :thead="['Kode Jenis', 'Nama Jenis' ,'Action']" :thwidth="[15, 15, 15, 15, 15]" :thclass="['', '', '', '', 'text-center']" />
<!-- END LIST DATA -->
                ...
                <div class="card-body pt-3 form-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="kode_jenis">Kode Jurusan</label>
                            <input class="form-control" type="text" placeholder="kode_jenis" id="kode_jenis"
...
<script>
    ...
    $('#form-tambah').validate({
        ...
        submitHandler: function(form, e) {
            ...
            if (parameter == "edit") {
                ...
                var pesan = "updated";
                var text = "Perubahan data " + kode_jenis + " telah tersimpan";


            } else {
                var url = "{{ url('dev-master/jenis') }}";
                var pesan = "saved";
                var text = "Data tersimpan dengan kode " + kode_jenis;
    ...
    $('#btn-edit').click(function() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                $('#judul-form').html('Update Jenis')
                $('#saku-datatable').hide();
                $('#saku-form').show();
                $('#kode_jenis').attr('value', data.daftar[0].kode_jenis)
