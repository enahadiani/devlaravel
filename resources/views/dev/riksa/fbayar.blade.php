...
<div class="col-12">
    <div class="card">
        <div class="card-body pb-3" style="padding-top:1rem;min-height:69.2px; position:sticky; top:55px; z-index:4; background-color:#FFFFFF; border-bottom: 1px solid #D7D7D7">
            <h5 style="position:absolute;top: 25px;">Data Bayar</h5>
            ...
            <div class="card-body pt-3 form-body">
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <label for="no_bayar">Kode bayar</label>
                                <input class="form-control" type="text" id="no_bayar" name="no_bayar">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 col-sm-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <label for="no_tagihan">Kode Tagihan</label>
