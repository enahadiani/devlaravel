<div class="card-body pt-2 pb-2 px-4 header-report" style="height:55px">
    <h6 style="position:absolute;top: 15px;">{{ $judul }}</h6>
    <button id="btn-filter" style="float:right;width:110px;position:relative;top:5px" class="btn btn-light ml-2 hidden" type="button"><i class="simple-icon-equalizer mr-2" style="transform-style: ;" ></i>Filter</button>
    <div class="dropdown float-right" style="position:relative;top:5px">
